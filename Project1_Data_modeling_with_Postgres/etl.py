...
def process_song_file(cur, filepath):
    """Function that opens a song file
    and insert song's and artist's features (columns)
...
def process_log_file(cur, filepath):
    """Function that opens the logs' file
    and add the time features and the users columns
    ...
    df = df[df.page.isin(['NextSong'])].reset_index(drop=True)
...
def process_data(cur, conn, filepath, func):
    """Function that apply the function
    specified in the parameters to all the files
    in the path as well specified in the params.
    """
